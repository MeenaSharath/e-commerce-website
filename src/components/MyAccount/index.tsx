...
const MyAccount = () => {
  ...
  const [billingAddress, setBillingAddress] = useState<AddressType | null>(null);
  const [shippingAddress, setShippingAddress] = useState<AddressType | null>(null);
...
const [newPassword, setNewPassword] = useState('');
  ...
  try {
    const response = await axios.put(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/updateUser`,
      {
        name: user.name,
        email: user.email,
        oldPassword,
  ...
  useEffect(() => {
   axios.get<{ user: UserType }>(`${process.env.NEXT_PUBLIC_API_BASE_URL}/getCurrentUser`, {
  withCredentials: true
})
.then(res => {
...
useEffect(() => {
  ...
  `${process.env.NEXT_PUBLIC_API_BASE_URL}/getOrderDetails/${encodeURIComponent(user.email)}`
);
        ...
        if (orders.length === 0) {
          ...
          setAddressError("No orders found.");
          setLoadingAddresses(false);
          return;
        }

        // Pick latest order (assuming orders are sorted by createdAt desc)
          ...
          <div className="flex flex-col xl:flex-row gap-7.5">
            ...
            <div className="xl:max-w-[370px] w-full bg-white rounded-xl shadow-1">
              <div className="flex xl:flex-col">
                <div className="hidden lg:flex flex-wrap items-center gap-5 py-4 px-4 border-r xl:border-r-0 xl:border-b border-gray-3">
                  <div>
                    <p className="font-medium text-dark mb-2">{user?.name || "Loading..."}</p>
                  </div>
                </div>
...
>
  <form onSubmit={handleChangePassword}>
    <div className="bg-white shadow-1 rounded-xl p-4">
      ...
      <div className="w-full">
        <label htmlFor="email" className="block mb-2 mt-3">
    ...
    <p className="text-custom-sm mt-3 mb-3">
      This will be how your name will be displayed in the account section and in reviews
    </p>

    <p className="font-medium text-xl text-dark mb-4">Password Change</p>
