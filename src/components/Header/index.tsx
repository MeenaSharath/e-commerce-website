...
const Header = () => {
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      try {
        ...
        console.log("Auth status updated:", data.isAuthenticated);
      } catch (error) {
  ...
  const options = [
    ...
    { label: "Furniture", value: "1", plink: `${process.env.NEXT_PUBLIC_API_BASE_URL}/categories/furniture` },
    { label: "Cosmetics", value: "2", plink: `${process.env.NEXT_PUBLIC_API_BASE_URL}/categories/cosmetic` },
    { label: "Fashion", value: "3", plink: `${process.env.NEXT_PUBLIC_API_BASE_URL}/categories/fashion` },
    { label: "Electronics", value: "4", plink: `${process.env.NEXT_PUBLIC_API_BASE_URL}/categories/electronics` },
    { label: "Grocery", value: "5", plink: `${process.env.NEXT_PUBLIC_API_BASE_URL}/categories/grocery` },
    { label: "Entertainment", value: "6", plink: `${process.env.NEXT_PUBLIC_API_BASE_URL}/categories/entertainment` },
    { label: "HealthCare", value: "7", plink: `${process.env.NEXT_PUBLIC_API_BASE_URL}/categories/health` },
  ];
  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        ...
        <div
          className={`flex flex-col lg:flex-row gap-5 items-end lg:items-center xl:justify-between ease-out duration-200 ${stickyMenu ? "py-1" : "py-1"
            }`}
        >

          {/* <!-- header top left --> */}
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center sm:gap-10">
            <Link className="flex-shrink-0" href="/">
              <Image
                src="/images/logo/logo-kartra.webp"
                alt="Logo"
                width={219}
                height={24}
              />
