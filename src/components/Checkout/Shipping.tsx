...
const Shipping: React.FC<ShippingProps> = ({ show, shippingData, onChange }) => {
  ...
  return (
    <div className="bg-white shadow-1 rounded-[10px] mt-7.5">
      <div
        ...
        className="cursor-pointer flex items-center gap-2.5 font-medium text-lg text-dark py-3 px-5.5"
      >
      ...
      {/* <!-- dropdown menu --> */}
      <div className={`p-4 ${dropdown ? "block" : "hidden"}`}>
        ...
        <div className="mb-5">
          ...
          <div className="relative">
            <select className="w-full bg-gray-1 rounded-md border border-gray-3 text-dark-4 py-3 pl-5 pr-9 duration-200 appearance-none outline-none focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20" id="shippingCountry">
